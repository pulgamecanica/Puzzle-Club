...
class ContributorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contributor" do
    assert_difference('Contributor.count') do
      post contributors_url, params: { contributor: { is_finished?: @contributor.is_finished?, puzzle_id: @contributor.puzzle_id } }
    end
  ...
  test "should update contributor" do
    patch contributor_url(@contributor), params: { contributor: { is_finished?: @contributor.is_finished?, puzzle_id: @contributor.puzzle_id } }
